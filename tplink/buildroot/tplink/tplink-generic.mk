...
# packages
$(BUILD_TPLINK_DIR)/%/.stamp_rsync_sourced:
...
# Clean package
$(BUILD_TPLINK_DIR)/%/.stamp_cleaned:
...
$(BUILD_TPLINK_DIR)/%/.stamp_uninstalled:
...
################################################################################
# tplink-inner-generic-package -- generates the make targets needed to build a
# generic package in tplink software system.
#
...
$(2)_DIR_PREFIX			= $(if $(4),$(4),$(TOP_SRCDIR)/tplink)
...
tplink-generic-package = $(call tplink-inner-generic-package,$(call pkgname),$(call UPPERCASE,$(call pkgname)),$(call UPPERCASE,$(call pkgname)),$(call pkgparentdir),target)
# In the case of host packages, turn the package name "pkg" into "host-pkg"
tplink-host-generic-package = $(call tplink-inner-generic-package,host-$(call pkgname),$(call UPPERCASE,host-$(call pkgname)),$(call UPPERCASE,$(call pkgname)),$(call pkgparentdir),host)
