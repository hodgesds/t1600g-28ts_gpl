...
#define __KERNEL_HEADERS__ "/Project/Trunk/Src_Linux/tplink/buildroot/output/toolchain/linux/include"
...
#define __CROSS_COMPILER_PREFIX__ "/Project/Trunk/Src_Linux/tplink/buildroot/host/usr/bin/arm-buildroot-linux-uclibcgnueabi-"
