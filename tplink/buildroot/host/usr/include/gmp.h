...
#define __GMP_CC "/Project/Trunk/Src_Linux/tplink/buildroot/host/usr/bin/ccache /usr/bin/gcc -std=gnu99"
#define __GMP_CFLAGS "-O2 -I/Project/Trunk/Src_Linux/tplink/buildroot/host/usr/include"
