...
/* define for TP-LINK Wolfhound board */
#define CONFIG_TP_WOLFHOUND_BOARD (1)
...
#if CONFIG_TP_WOLFHOUND_BOARD
#define CONFIG_PHYS_SDRAM_1_SIZE	(0x8000000) /* 128 MB */
#else
...
#define CONFIG_BOOTARGS     	"console=ttyS0,38400n8 maxcpus=1 mem=112M mtdparts=spi1.0:896K(boot),128K(env),6144K(sys),10240K(usrimg1@main),10240K(usrimg2),4096K(usrappfs),1024K(para)"
#endif

#define CONFIG_MACH_TYPE  0xbb8

#define CONFIG_CMD_LOADB   /* include the loadb command */
#define CONFIG_ETHADDR		00:0a:eb:00:13:72
...
#define CONFIG_SF_DEFAULT_SPEED                 31250000
...
#define CONFIG_ENV_OFFSET                       0xe0000 /*changed by wangshengjun, 896K uboot, 128K env sector*/  
...
#ifdef CONFIG_TP_WOLFHOUND_BOARD
#define CONFIG_SYS_FLASH_BASE       0x1C000000   /* use SPI flash base address */
#else
