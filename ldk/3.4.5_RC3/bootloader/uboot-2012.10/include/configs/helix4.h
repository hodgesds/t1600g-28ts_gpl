...
/* define for TP-LINK Helix4 board */
#define CONFIG_TP_HELIX4_BOARD (1)
...
#if CONFIG_TP_HELIX4_BOARD
#define CONFIG_PHYS_SDRAM_1_SIZE			0x10000000 /* 256MB *//*H5TQ2G63DFR-H9C|2Gbit|16Mbit*16Bit*8Banks  Row address:14bit; column address:10bit; Page Size:2KB*/
#else
