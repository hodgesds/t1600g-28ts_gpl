...
struct pci_controller *pci_bus_to_hose (int bus)
{
	...
	hose_head = &local_hose;
	printf("pci_bus_to_hose(): 0x%08x\n", hose_head);
...
extern void pci_iproc_init_board (struct pci_controller * hose);
...
void pci_init(void)
{
	...
	pci_iproc_init_board(&local_hose);
}
