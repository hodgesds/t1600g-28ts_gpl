...
extern bool 
pktfastfree_wrapper(struct sk_buff *skb);
			    ...
			    int flags, int node)
{
    ...
    skb->napt_hash_ix = BCM_CTF_INVALID_IDX_VAL;
...
#endif
#if (defined(CONFIG_IPROC_FA) || defined(CONFIG_IPROC_FA2))
    new->napt_hash_ix = old->napt_hash_ix;
    new->napt_bkt_ix = old->napt_bkt_ix;
#endif
